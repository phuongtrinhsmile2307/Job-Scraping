...
class SkillsExtractor:
    ...
    def _load_soft_skills(self) -> List[str]:
        ...
        return [
            "Accountability", "Attention To Detail", "Active Learning", "Adaptability", 
            "Analytical Thinking", "Building Rapport", "Business Acumen", "Change Management",
            "Coaching", "Cognitive Flexibility", "Collaboration", "Communication", 
            "Conflict Management", "Conflict Prevention", "Conflict Resolution", 
            "Consensus Building", "Creativity", "Critical Observation", "Critical Thinking", 
            "Cross-Cultural", "Cultural Awareness", "Customer Service", 
            "Customer-Centric Mindset", "Curiosity", "Data-Driven", "Decision Making",
            "Under Pressure", "Delegation", "Diplomacy", "Diversity and Inclusion Awareness", 
            "Emotional Intelligence", "Emotional Regulation", "Empathy", "Empowerment", 
            "Enthusiasm", "Ethical Judgment", "Facilitation", "Flexibility", "Fast Learner", 
            "Giving and Receiving Feedback", "Goal Setting", "Grit", "Growth Mindset", 
            "Handling Constructive Criticism", "High-Stakes Decision Making", "Influencing", 
            "Initiative", "Insight Generation", "Innovation", "Interpersonal", "Leadership", 
            "Listening", "Logical Reasoning", "Mentoring", "Motivational", "Negotiation", 
            "Networking", "Open-Mindedness", "Ownership Mentality", "Patience", 
            "People Management", "Persuasive Communication", "Persuasion", 
            "Positive Attitude", "Presentation Skills", "Problem Sensitivity", 
            "Problem-Framing", "Process Improvement", "Process Optimization", 
            "Professionalism", "Public Speaking", "Reliability", "Relationship Building",
            "Resilience", "Resourcefulness", "Risk Management", "Scenario Planning", 
            "Self-Confidence", "Self-Discipline", "Self-Learning", "Self-Motivation", 
            "Self-Reflection", "Situational Awareness", "Stakeholder Management", 
            "Storytelling", "Strategic Thinking", "Stress Management", 
            "Synthesizing Information", "Systems Thinking", "Team Building", 
            "Time Management", "Tolerance for Ambiguity", "Trustworthiness", 
            "Work Ethic", "Work-Life Balance", "Mindfulness"
        ]
    ...
    def _load_domains(self) -> List[str]:
        ...
        return [
            ...
            "Cognitive Science", "Commercial Real Estate", "Compliance", "Computer Science",
            ...
            "Economic Policy", "Economics", "Education", "Elder Care", "Electric Vehicles",
            ...
            "Industrial Engineering", "Information Security", "Information Technology",
